...
urlpatterns = [
    ...
    path('accept/page/<int:id>/all/', AcceptAllFollowersPageView.as_view(), name='accept_all_folowers'),
    path('accept/page/<int:id>/user/<int:idOfUser>/', AcceptFollowerForPageView.as_view(),
